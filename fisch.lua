local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))() -- gui loader
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))() -- config saver
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))() -- gui anims etc loader
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Your Script Name",
-- Replace "Your Script Name" with anything
-- "game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name" gets the name of fisch example, it would show: Fisch [🐋MARIANA]


    SubTitle = " v0.0.0 ", -- your script version
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/") -- your discord inv link
        end
    })
